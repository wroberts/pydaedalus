/*
** Daedalus (Version 3.2) File: inside.cpp
...
KV KvStarRandom()
{
  ...
  if (dr.lStarColor != 0 && Rnd(0, 98) < (int)(dr.lStarColor / 1000000L)) {
    switch (Rnd(0, 2)) {
    case 0:
      nR0 = (int)(dr.lStarColor / 100000L % 10);
      nR1 = (int)(dr.lStarColor / 10000L  % 10);
      nR += Rnd(0, (nR0 + nR1) * 511 / 18) - (nR0 * 511 / 18);
      EnsureBetween(nR, 0, 255);
      break;
    case 1:
      nG0 = (int)(dr.lStarColor / 1000L % 10);
      nG1 = (int)(dr.lStarColor / 100L  % 10);
      nG += Rnd(0, (nG0 + nG1) * 511 / 18) - (nG0 * 511 / 18);
      EnsureBetween(nG, 0, 255);
      break;
    case 2:
      nB0 = (int)(dr.lStarColor / 10L % 10);
      nB1 = (int)(dr.lStarColor       % 10);
...
flag FCreateInsideStars(CMazK *c, real rd, int yAdd, flag fPerspective)
{
  ...
  for (i = 0; i < dr.cStar; i++) {
    ...
    if ((rd + dInside2 < rDegMax) ?
      ...
      y = yAdd + (int)((real)(c->m_y >> (int)!dr.fSkyAll) *
...
void DrawBackground(CMazK &c, flag f3D, real rd, int yb)
{
  ...
  if (!f3D || dr.z <= 0 || dr.fSky3D) {
    ...
    if (dr.fStar && dr.nMeteor > 0) {
      yb -= c.m_y >> 1;
      y = (c.m_y >> (int)!dr.fSkyAll) - 1;
