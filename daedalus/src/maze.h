/*
** Daedalus (Version 3.2) File: maze.h
...
public:
  ...
  int DirFindUncreatedCore(int *, int *, flag) CONST;
  ...
  flag CreateMazeInfinite(int phase);
  ...
  void CreateMazeTilt();
  void LabyrinthPartial(int, int, int);
...
extern flag FSetCoordinates(int, int, int, int, int, int);
