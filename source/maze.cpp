/*
** Daedalus (Version 3.2) File: maze.cpp
...
MS ms = {
  // File settings
  0L, 0L, 0L, fFalse, fFalse, fFalse, fFalse, 1,
  // Random settings
  109, 0, 0,
  // Dot settings
  0,
  ...
  fTrue, fTrue, fTrue, 13, 2, -1, -1, 0, "a2a3a0a1",
    ...
    fFalse, 1000, TRIES, 0, 0, fFalse, fFalse, fFalse, 4,
  // Macro accessible only settings
  -1, 10, 50, 0,
  // Internal settings
  1, 0, 1, 0, 0, 0, 0, 0, -1L, NULL, fFalse, 0L, NULL, 0};
...
int CMaz::DirFindUncreatedCore(int *x, int *y, flag fWall) CONST
{
